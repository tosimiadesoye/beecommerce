...
router.get(
  "/api/product/layout/:pId/product_type",
  controller.getHomeProductsType
);
router.get(
  "/api/product/:pId/product_type",
  controller.getSimilarProductForType
); //'${port}api/product/10/product_type?keyword=mascara'
...
router.get("/api/product_type", controller.getProductType); //e.g ${port}api/product_type?keyword=bronzer
router.get("/api/description", controller.getDescription); //`${port}api/description?keyword=${value}
